...
INPUT_DIR = '../lexisnexis/to_process/'
OUTPUT_FILE = '/results/parser/processed-file.txt'
TEMPLATE_FILE ='./lexisnexis/second_template.txt'
DEBUG = False
...
def writeParsedDocumentsToFile(writer, documents, templateString):
	...
	for doc in documents:
		writer.writeOutput(templateString.format(counter,
												totalDocs,
												doc['source'],
												doc['date'],
												doc['title'],
